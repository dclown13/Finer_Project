...
public class AuctionsController implements AuctionsInterface {
	...
	public boolean itemName(String itemName) { // 경매할 물품의 정보를 입력받고 사이트에 등록
		return false;
	}

	@Override
	public boolean login(String id, String pw) { // 로그인이 여부
		return false;
	}
	...
	@Override
	public int price(int price) { // 사용자들의 가격을 입력 받는
		return 0;
	}
	...
	@Override
	public Date date(Date date) { // 경매 시작 날짜(yyyy/MM/dd) / 사용자의 구입날짜
		return null;
	}
